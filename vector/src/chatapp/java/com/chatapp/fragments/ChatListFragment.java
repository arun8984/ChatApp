...
public class ChatListFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((ChatMainActivity)getActivity()).initAd();
...
//                    summary.setHighlightCount(-101);
//                    mMainRoomList.add(i, summary);
//                }
//            }
//        }
    ...
    public void onResume() {
        super.onResume();
        callAdapter();
        ((ChatMainActivity)getActivity()).showAd();
    }
