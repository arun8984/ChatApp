...
public class ContactsDetailsActivity extends AppCompatActivity {
    ...
    View.OnClickListener InviteSMSListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            intent.putExtra("sms_body", "Join me on FNF Call, this free video chat and messaging app is amazing. I like it! https://play.google.com/store/apps/details?id=com.fnfcall");
