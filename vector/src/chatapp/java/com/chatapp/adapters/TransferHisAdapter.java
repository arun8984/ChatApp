...
public class TransferHisAdapter extends ArrayAdapter<TransferHisItem> {

    Context context;
    int layoutResourceId;
    List<TransferHisItem> Items;
    MXSession mSession;
    ...
    public TransferHisAdapter(Context context, int resource, List<TransferHisItem> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       TransferHisAdapter.ViewHolder holder = null;
        ...
        if(row == null)
        {
            ...
            holder = new TransferHisAdapter.ViewHolder();
        ...
        {
            holder = (TransferHisAdapter.ViewHolder)row.getTag();
        }
        TransferHisItem Item = this.Items.get(position);
    ...
    @Override
    public TransferHisItem getItem(int position) {
